...
- **Streamlit** + **Plotly** for the dashboard *(in progress)*
...
├── streamlit_app/
│   └── app.py                      # dashboard (reads exported Gold CSVs)
...
*Streamlit dashboard in progress. It reads the four exported Gold CSVs and presents one panel per table: significance distribution, top genes, chromosome distribution with pathogenic proportion, and a searchable condition-burden table. Setup instructions and screenshots to be added.*

---

*ClinVar Medallion Pipeline · Efi Tentsidou · 2026*
